import { ClassType, BasicFunction } from "./index";
...
export type ClassDecorator = (
    ...
    (targetClass: TClassType) => TClassType | void
);
...
export type MethodDecorator<TArgs extends any[] = any[], TRetval = any> = (
    <
        ...
        TProtoOrClass extends Record<TMethodName, BasicFunction<TArgs, TRetval, TProtoOrClass>>
    >(
        protoOrClass:     TProtoOrClass,
        methodName:       TMethodName,
        methodDescriptor: TypedPropertyDescriptor<BasicFunction<TArgs, TRetval, TProtoOrClass>>
    ) => void |           TypedPropertyDescriptor<BasicFunction<TArgs, TRetval, TProtoOrClass>>
);
